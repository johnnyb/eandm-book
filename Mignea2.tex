...
artificial SSR are considered. The emerging complexity of the artificial
...
b\textsubscript{3},{\jdots}, b\textsubscript{N }so that Machine A can copy
each constituent part.
\item Then Machine A will copy all parts b\textsubscript{1},
b\textsubscript{2}, b\textsubscript{3},{\jdots}, b\textsubscript{N} twice (to
...
ca\textsubscript{2}, ca\textsubscript{3},{\jdots}, ca\textsubscript{N }(for
Copy\textsubscript{A} machine) and cb\textsubscript{1},
cb\textsubscript{2}, cb\textsubscript{3},{\jdots}, cb\textsubscript{N} (for
...
ca\textsubscript{1}, ca\textsubscript{2}, ca\textsubscript{3},{\jdots},
ca\textsubscript{N} and assemble them together into the
Copy\textsubscript{A} machine and parts cb\textsubscript{1},
cb\textsubscript{2}, cb\textsubscript{3},{\jdots}, cb\textsubscript{N} and
...
b\textsubscript{3},{\jdots}, b\textsubscript{N} and for each such part, a
...
\section{The Most Significant Challenges for the Design and Implementation of an Artificial SSR}
\sectionmark{The Most Significant Challenges}
...
\subsection[The Information Closure Challenge and the Hardware/Software Completeness Challenge]{The Information Closure Challenge and the \mbox{Hardware/Software} Completeness Challenge}
...
%[Attempts to Build Artificial Self-Replicators]
...
to the robot \citecustom{zykovetal2005}{Zykov, Mytilinaios, Adams, \& Lipson}.
...
self-replicating factory: ``In the lower left corner, a lunar
...
some simplifying assumptions.  These might include the following:
