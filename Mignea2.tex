\chapter{Developing Insights into the Design of the Simplest Self-Replicator and its Complexity: Part 2---Evaluating the Complexity of a Concrete Implementation of an Artificial SSR}

\author{Arminius Mignea}
...
%% FIXME - need a transition from previous paper
...
%% FIXME - why does this transition from enumerate to itemize?
...
%% FIXME - why is there just one enumeration?
...
%% FIXME - I think this should be #2 from the previous question I had
...
%% FIXME - missing words?  Also refer to figure by number
...
%% FIXME - missing text? Also refer to figure by number
...
%% FIXME - abrupt stop - transition to the next chapter
