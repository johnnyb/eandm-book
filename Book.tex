...
\usepackage[top=1in,bottom=0.5in,left=0.5in,right=0.5in, paperwidth=6.14in, paperheight=9.21in]{geometry}
\usepackage{etoolbox}
...
\newcommand\eandmbibliography[1]{\unnumberednotocsection{Bibliography}{Bibliography} \bibliographystyle{eandm_url}\bibliography{#1}}
