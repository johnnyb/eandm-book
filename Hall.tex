...
and obedience and surrender of themselves and theirs to His will”\citep[][pp.~16]{ruskin1920}
...
stonecraft”\citep[][pp.~300]{matteson2002}. Matteson observes that both the
...
insinuated themselves into the building of the cathedral” \citep[][pp.~301]{matteson2002}.  
\index{Cathedral of St. John the Divine|)}
...
words, may be deciphered'' (author's emphasis) \citep[][pp.~56]{carlyle1971}.  
Uhlig
...
\citep[][pp.~502]{uhlig1985}.  The presence of the past coexists with the text; thus,
...
past'' \citep[][pp.~502]{uhlig1985}.  Deciphering the present moment of the
...
could be read through over-writing''\citep[][pp.~309]{darville2002}.  When
used in the field of archae-ology, ``the term is often
applied to landscapes in which traces of earlier arrangements can be
seen amongst and below the modern pattern''\citep[][pp.~309]{darville2002}, 
...
dynamic reality of the living city” \citep[][pp.~207]{eisenman2004}.  Eisenman describes an architectural
...
something not of its own genre---art, music, architecture \citep[][pp.~503]{uhlig1985}. 
\index{architecture!as palimpsest|)}
\index{architecture!as text|)}
...
and celebrated its originality. I felt honored and elated” \citep[][pp.~85]{libeskind2004}.
...
its future.  \citep[][pp.~83]{libeskind2004}
\end{quote}
...
presentness of the past'' \citep[][pp.~502]{uhlig1985}.  Earle acknowledges
...
and the immanences of a possible presence” \citep[][pp.~207]{eisenman2004}.  In
