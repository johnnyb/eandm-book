...
sense of calling.  John Ruskin, a 19th century critic, used the Gothic
style of cathedrals as an example to his contemporaries of the
transcendental and moral ideals of architecture, which he categorizes as seven lamps or laws.
...
design these structures demonstrates their philosophy that architecture
...
that an edifice will influence the life of the inhabitant and that it will be
...
\noindent Ruskin observes that society and architecture are invariably connected.
...
\noindent He explains that the word ``text'' when used
...
\section{Peter Eisenman and \textit{The Memorial for the Murdered Jews of Europe}}
%[Peter Eisenman and \textit{The Memorial}]
...
\citep{quigley2005}, “acknowledge[ing] the dynamic reality of the living city” \citep[][p.~207]{eisenman2004}.  Nicolai Ouroussoff explains: 
...
\noindent Sarah Quigley, a novelist and critic, describes her encounter with the
memorial: 
...
\noindent In this memorial the past haunts both the present and the future.
...
\index{Jewish Museum Berlin, The|(}
