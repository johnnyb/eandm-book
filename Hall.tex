...
\begin{abstract}
The guiding lights of modern architecture are largely functional and aesthetic---how it
works and how it looks.  However, historically, architecture has been guided by a deeper
sense of calling.  John Ruskin, a 19th century architecture critic, used gothic
architecture of cathedrals as a means of reminding his contemporaries about the
transcendental and moral ideals of architecture, which he calls the \textit{seven lamps}.
Just as gothic architecture served as a palimpsest to Ruskin, Ruskin's work is
beginning to serve as a 
palimpsest to a new generation of architects whose work incorporates various aspects
of Ruskin's seven lamps.
\end{abstract}
