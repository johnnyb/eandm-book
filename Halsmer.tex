...
Reverse Engineering with Application to Complex Systems” \citecustom{halsmeretal2009}{Halsmer, Roman, and Todd}.
} suggests that
...
robustly achieve biological function” \citecustompg{joint2008}{Khammash, Tomlin, and Vidyasagar}{p.~4}.
...
engineered system, see ``The Applicability of
Engineering Design Principles in Formulating a Coherent Cosmology and
Worldview'' \citecustom{halsmeretal2008}{Halsmer, Halsmer, Johnson, Wanjiku}, and ``The Coherence of an
Engineered World'' \citecustom{halsmeretal2009b}{Halsmer, Asper, Roman, and Todd}.
...
Design Space Exploration for Biological Systems” \citecustom{polstraetal2008}{Polstra, Pronk, Pimentel, and Breit}
...
Missionaries to Technical Communities” \citecustom{halsmeretal2011}{Halsmer, Asper, and Zigrang},
...
including both AUA and AAA \citecustom{maieretal2003}{Maier, Ezhilan, and Fadel}\citecustom{maieretal2008}{Maier, Sandel, and Fadel}. The system is then
...
heat shock \citecustom{elsamadetal2005}{El-Samad, Kurata, Doyle, Gross, and Khammash}, claiming that it “is just what a
...
beings \citecustom{barrow2008}{Barrow, Morris, Freeland, and Harper Jr}. These affordances are facilitated by the
