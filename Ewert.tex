...
However, the hypothesis that the sentence was generated by choosing random English letters can also be analyzed.
...
A program which, given the laws of physics, outputs a particular protein, can be created.
\begin{figure}[H]
\begin{mdframed}
\begin{verbatim}
...
\index{complexity!metrics!algorithmic specified complexity|(}
Kirk Durston et al. have defined the idea of {\it functional sequence complexity} \citecustom{Durston2007}{Durston, Chiu, Abel, and Trevors}.
